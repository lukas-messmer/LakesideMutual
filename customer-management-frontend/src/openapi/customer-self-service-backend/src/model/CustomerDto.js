...
class CustomerDto {
    ...
    constructor(streetAddress, postalCode, city) { 
        ...
        CustomerDto.initialize(this, streetAddress, postalCode, city);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CustomerDto.RequiredProperties) {
...
CustomerDto.RequiredProperties = ["streetAddress", "postalCode", "city"];
