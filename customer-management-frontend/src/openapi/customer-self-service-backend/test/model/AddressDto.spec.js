...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerSelfServiceApi.AddressDto();
  });
  ...
  describe('AddressDto', function() {
    it('should create an instance of AddressDto', function() {
      ...
      //var instance = new CustomerSelfServiceApi.AddressDto();
      //expect(instance).to.be.a(CustomerSelfServiceApi.AddressDto);
    });
