...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerSelfServiceApi.CustomerInfoDto();
  });
  ...
  describe('CustomerInfoDto', function() {
    it('should create an instance of CustomerInfoDto', function() {
      ...
      //var instance = new CustomerSelfServiceApi.CustomerInfoDto();
      //expect(instance).to.be.a(CustomerSelfServiceApi.CustomerInfoDto);
    });
