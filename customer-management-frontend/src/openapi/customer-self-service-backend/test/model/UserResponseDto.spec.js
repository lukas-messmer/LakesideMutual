...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerSelfServiceApi.UserResponseDto();
  });
  ...
  describe('UserResponseDto', function() {
    it('should create an instance of UserResponseDto', function() {
      ...
      //var instance = new CustomerSelfServiceApi.UserResponseDto();
      //expect(instance).to.be.a(CustomerSelfServiceApi.UserResponseDto);
    });
