...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerSelfServiceApi.CustomerDto();
  });
  ...
  describe('CustomerDto', function() {
    it('should create an instance of CustomerDto', function() {
      ...
      //var instance = new CustomerSelfServiceApi.CustomerDto();
      //expect(instance).to.be.a(CustomerSelfServiceApi.CustomerDto);
    });
