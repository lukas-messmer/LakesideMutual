...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerManagementApi.CustomerDto();
  });
  ...
  describe('CustomerDto', function() {
    it('should create an instance of CustomerDto', function() {
      ...
      //var instance = new CustomerManagementApi.CustomerDto();
      //expect(instance).to.be.a(CustomerManagementApi.CustomerDto);
    });
